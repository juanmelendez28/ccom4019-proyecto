 ...
 * Model Class
 * 
 * This class is used to create and manage models. 
 * Every model must inherit from this class so it can use the CRUD methods,
 * we need to use the Query Builder which is the connector.php under the database folder
 * in order to create and execute queries.
 * 
 * Note: Make sure you've setted up the database connection in the config.php file under the util folder.
 * 
 * @author @ricardo-morales25
 */
class Model
{
     ...
     *
     * This method is protected from direct instantiation. To create a new instance
     * of the Model class, use the static create() or find() methods.
     *
     * @param array $attributes The attributes of the model.
     * @param array $sanitized  The sanitized values of the model.
     *
     * @return void
     */
    ...
    private static function init()
    {
        ...
        /**
         * We're avoiding to initialize the model more than once
         */
        if (self::$initialized) {
            return;
        }
        ...
        /**
         * We're using by default the plural form of the class name,
         * for example if the child model is called "User", the table name will be "users".
         */
     ...
     */
    public static function findAll($id, string $column = null, string $table = null): array
    {
        self::init();
     ...
     */
    public static function find($id, string $column = null): Model
    {
        self::init();
    ...
    /**
     * Updates the model attributes with the provided data array and saves the changes to the database.
     *
    ...
    /**
     * Deletes the record associated with the current model from the database.
     *
